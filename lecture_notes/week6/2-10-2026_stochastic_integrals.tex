...
\begin{equation}
\frac{d}{dt}W_t^2 = 2W_t\dot{W_t} + 1
\end{equation}
...
\begin{equation}
dX_t = r X_t\, dt + \alpha X_t\, dW_t,
\qquad X_0>0,
\end{equation}
which defines a geometric Brownian motion.  
To solve it, we apply It\^o's formula to $f(x) = \log x$. Since $X_t>0$ almost surely, this is well defined.  
...
\frac{1}{X_t}\, r X_t
+
\frac12\left(-\frac{1}{X_t^2}\right)\alpha^2 X_t^2
\right) dt
+
\frac{1}{X_t}\,\alpha X_t\, dW_t \\[0.5em]
&=
\left(
r - \tfrac12\alpha^2
\right) dt
